...
const BannerBoxV2 = (props) => {
  return (
    <div className="bannerBoxV2 box overflow-hidden w-full rounded-md group relative">
        ...
        <div className={`info absolute p-5 top-0 ${props.info==="left" ?"left-0" :"right-0"} w-[70%] h-[100%] z-50 flex items-center justify-center flex-col gap-2 ${props.info ==="left"? " " : "pl-16"}`} >
            <h2 className='text-[14px] md:text-[18px] font-[600]'>{props.item?.bannerTitle || "Fantastic Products"}</h2>
