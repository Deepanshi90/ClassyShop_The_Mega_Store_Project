...
setIsOpenCatPanel(props?.isOpenCatPanel)
           ...
           <div className="col_2 w-full lg:w-[60%]">
            <ul className="flex items-center gap-3 nav">
              <li className="list-none">
                <Link to="/" className='link transition text-[14px] font-[500px]'>
                <Button className='link transition !font-[500]
                        !text-[rgba(0,0,0,0.8)] hover:!text-[#ff5252] !py-4'>Home</Button>
                </Link>
              </li>
              {
 ...
 <li className="list-none relative" key={index}>
                <Link to="/productListing" className='link transition text-[14px] font-[500px]'>
                <Button className='link transition !font-[500]
...
//                             return(
//                                 <li className='list-none relative' key={index}>
//                                 <Link to={`/productListing?catId=${cat?._id}`} className='link transition text-[14px] font-[500]'>
...
//                     cat?.children?.map((subCat,index_) =>{
// return(
//     <li className="list-none"><Link to={`/productListing?catId=${subCat?._id}`} className='w-full' key={index_} >
...
//     <Link to={`/productListing?catId=${thirdLevelCat?._id}`} className='w-full'>
//     <Button className='!text-[rgba(0,0,0,0.8)] w-full !text-left !justify-start !rounded-none'>
//         {thirdLevelCat?.name}
//     </Button></Link>
// </li>
