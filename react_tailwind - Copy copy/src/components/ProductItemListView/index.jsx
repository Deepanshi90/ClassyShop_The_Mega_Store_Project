...
const ProductItemListView = (props) => {
  ...
  return (
    <div className="productItem rounded-md overflow-hidden border-1 border-[rgba(0,0,0,0.1)] shadow-lg flex items-center flex-col lg:flex-row">
        <div className=" group imagWrapper w-full lg:w-[25%]  overflow-hidden rounded-md relative">
        ...
        <div className="info p-3 px-3 lg:px-8 py-5 w-full lg:w-[75%] ">
            ...
            <p className='text-[14px] mb-3'>{props.item?.description?.substr(0,180)+ '....'}</p>
