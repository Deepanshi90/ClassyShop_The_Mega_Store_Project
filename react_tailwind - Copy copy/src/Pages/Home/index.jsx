...
const context = useContext(MyContext);
 ...
 fetchDataFromApi(`/api/product/getAllProductsByCatId/${context?.catData[0]?._id}`).then((res) =>{
      console.log("home page get all product cat id ",res);
      if(res?.error === false){
  ...
  popularProductsData?.length !== 0 &&  <ProductsSlider items={6} data={popularProductsData}/>
    ...
    <section className='py-6 pt-0 bg-white'>
      <div className="container flex flex-col lg:flex-row  gap-5">
        ...
        <div className="part2 w-full scrollableBox lg:w-[30%] flex items-center gap-5 justify-between flex-row lg:flex-col">
    ...
    <section className=" py-0 lg:py-4 pt-0 lg:pt-8 pb-0 bg-white">
      <div className="container">
        <div className="freeShipping w-full md:w-[80%] m-auto p-4 py-4 pb-0 border-2 border-[#ff5252] flex items-center justify-center lg:justify-between rounded-md mb-7 
        flex-col lg:flex-row">
          ...
          <p className="font-bold text-[20px]  lg:text-[25px]">- Only Rs.200*</p>
        </div>
{
