...
const myAccount = () => {
  ...
  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-6">
    <Button
      ...
      className="btn-org btn-lg w-full sm:w-auto"
    >
      {isLoading ? <CircularProgress color="inherit" size={24} /> : "Update Profile"}
    </Button>
    <Button type="button" className="btn-org btn-border btn-lg w-full sm:w-auto">
      Cancel
    </Button>
  </div>
</form>
 ...
 <div className="col">
  ...
  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 mt-6">
    ...
    <Button
      type="button"
      className="btn-org btn-border btn-lg w-full sm:w-auto"
    >
      Cancel
    </Button>
  </div>
