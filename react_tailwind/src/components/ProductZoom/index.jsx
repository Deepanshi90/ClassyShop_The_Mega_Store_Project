    ...
    return (
        <div className="flex gap-3">
            ...
            <div className="slider w-[15%] h-[500px]">
                ...
                >
                    <SwiperSlide>
                        <div className={`item rounded-md overflow-hidden cursor-pointer group ${slideIndex === 0 ? 'opacity-50':'opacity-100'}`} onClick={() => goto(0)}>
                            <img
                                src="https://www.jiomart.com/images/product/original/rvmzhnmejf/keitra-klosia-women-purple-printed-cotton-blend-kurta-and-pant-set-product-images-rvmzhnmejf-0-202405131403.jpg?im=Resize=(600,750)"
                                alt="Thumb 1"
