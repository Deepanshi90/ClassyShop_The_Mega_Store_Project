...
//             <p className='text-center mt-0 mb-4'>OTP send to <span className='text-[#ff5252] font-bold'>{localStorage.getItem("userEmail") || "your email"}</span></p>
      ...
      <div className="container">
        <div className="card shadow-md w-[400px] m-auto rounded-md bg-white p-5 px-10">
          ...
          <p className='text-center mt-0 mb-4'>
            OTP sent to <span className='text-[#ff5252] font-bold'>{userEmail || "your email"}</span>
          </p>
