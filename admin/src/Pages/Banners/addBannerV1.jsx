...
<section className='p-5 bg-gray-50'>
  <form className="form p-4 sm:p-8 py-3" onSubmit={handleSubmit}>
    <div className='scroll max-h-[75vh] overflow-y-auto pr-2 sm:pr-4 pt-4'>
      ...
      {/* Input Grid Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5 mb-3">
        ...
        {/* Text Alignment */}
        <div>
          <h3 className="text-sm font-medium mb-1">Text Alignment</h3>
          <Select
            size='small'
            value={alignInfo}
            onChange={handleChangeAlignInfo}
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-4">
          {previews.length > 0 && previews.map((image, index) => (
            <div className="relative" key={index}>
              <span
                className='absolute w-5 h-5 rounded-full bg-red-700 -top-1 -right-1 flex items-center justify-center text-white text-sm cursor-pointer z-50'
