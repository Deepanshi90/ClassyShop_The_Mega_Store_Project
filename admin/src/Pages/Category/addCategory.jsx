...
const AddCategory = () => {
  ...
  .catch((err) => {
    ...
    return (
        ...
        <section className="p-4 md:p-5 bg-gray-50">
  <form className="form p-2 md:p-8" onSubmit={handleSubmit}>
    
    <div className="scroll max-h-[75vh] overflow-y-scroll pr-2 md:pr-4 pt-4 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="w-full">
          ...
          <input
            type="text"
            className="w-full h-10 border border-[rgba(0,0,0,0.2)] rounded-sm p-3 text-sm focus:outline-none focus:border-[rgba(0,0,0,0.4)]"
            name="name"
            value={formFields.name}
            onChange={onChangeInput}
          />
          ...
          {previews.length > 0 &&
            previews.map((image, index) => (
              <div className="relative" key={index}>
                ...
                <div className="uploadBox p-0 rounded-md overflow-hidden border border-dashed border-[rgba(0,0,0,0.3)] h-[150px] w-full bg-gray-100 hover:bg-gray-200 flex items-center justify-center flex-col relative">
