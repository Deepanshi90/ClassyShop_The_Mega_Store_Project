    ...
    <>
      ...
      {/* <div className="grid grid-cols-1 md:grid-cols-2 px-2 py-0 mt-1 md:mt-2"> */}
        ...
        <div className="col w-[25%] ml-auto flex items-center gap-3 justify-end"> */}
         {/* <h2 className='font-[600] text-[18px]'>Home Slider Banners</h2>
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-2 px-2 py-0 mt-1 md:mt-2 items-center">

  {/* Heading Section */}
  <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
    <h2 className='font-semibold text-[18px] text-gray-800'>Home Slider Banners</h2>
