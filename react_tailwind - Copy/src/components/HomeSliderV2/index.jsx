      ...
      >
        <SwiperSlide>
          ...
          <div className="info absolute top-0 -right-[100%] opacity-0 w-[50%] z-50 p-8 h-[100%] flex items-center flex-col justify-center transition-all duration-700">
            ...
            <h3 className='flex items-center gap-3 font-[500] text-[12px] lg:text-[18px] w-full text-left mt-3 mb-3 relative -right-[100%] opacity-0 duration-1000 '>
              <span className='block lg:inline w-full lg:w-max'>Starting At Only </span>
                <span className='text-[#ff5252] text-[16px] lg:text-[30px] font-[700] block lg:inline w-full lg:w-max'>Rs.100</span>
            </h3>
            <div className='w-full relative -right-[100%] opacity-0 duration-1000 btn_'>
           <Link to="/productListing">
           {/* <Link to={`/product/${item?._id}`}></Link> */}
            <Button className='btn-org btn'>Shop Now</Button></Link>
            </div>
          </div>
          </div>
        </SwiperSlide>
         ...
         <SwiperSlide>
          ...
          <div className="info absolute top-0 -right-[100%] opacity-0 w-[50%] z-50 p-8 h-[100%] flex items-center flex-col justify-center transition-all duration-700">
            <h4 className='font-[500] text-[12px] lg:text-[18px] w-full text-left mb-3 relative -right-[100%] opacity-0 duration-1000'>
            Big Saving Days Sale</h4>
            <h2 className='font-[700] text-[15px] sm:text-[15px] md:text-[18px] lg:text-[35px] w-full relative -right-[100%] opacity-0 duration-1000'>Buy Modern Chair In
Black Color
            </h2>
            <h3 className='flex items-center gap-3 font-[500] text-[12px] lg:text-[18px] w-full text-left mt-3 mb-3 relative -right-[100%] opacity-0 duration-1000 '>
              <span className='block lg:inline w-full lg:w-max'>Starting At Only </span>
